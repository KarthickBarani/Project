        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark">
                <div className="container-fluid">
                    <a href="#" className="navbar-brand fw-bolder fs-1" ><span className="svg-icon svg-icon-light svg-icon-3hx"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto fw-bold fs-6">
                            <li className="nav-item">
                                <a className="nav-link active" ><span className="svg-icon svg-icon-light svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="/"><span className="svg-icon svg-icon-light svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <li className="nav-item symbol symbol-25px symbol-circle pt-2 px-2">
                                <a className="nav-link symbol-label fs-5 fw-bold text-success" href="">A</a>
                            </li>
                        </ul>
                    </div>
                </div>
