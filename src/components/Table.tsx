...
export const Table = () => {
    const data = React.useMemo(
        () => [
            {
                no: 1,
                action: <td className="min-w-100px align-items-start h-100 text-center">
    ...
    return (
        <div className='table-responsive' >
            <table {...getTableProps()} className='table table-rounded table-hover'>
                <thead className='fw-bolder fs-5'>
                ...
                <tbody {...getTableBodyProps()} className='fw-bold fs-6' >
                    {rows.map(row => {
                        prepareRow(row)
                        return (
                            <tr {...row.getRowProps()}>
