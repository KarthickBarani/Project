...
export const InvoiceDetail = (props) => {
    ...
    const { isLoading, data, isError } = useQuery('invDetails', () => {
                    ...
                    <div className="col">
                        <div className="card card-flush shadow-sm">
                            ...
                            <div className="card-body">
                                {isLoading ? <Loading /> : isError ? <h4>Something Error in Server</h4> : <Form invDetails={invDetails} ></Form>}
                            </div>
                        </div>
                    </div >
                </div >
                                        ...
                                        <div className={collapseClass}>
                                            ...
                                            <div className="tab-content h-100">
                                                <div className="tab-pane fade h-100" id="itemsTab" role="tabpanel">
                                                    {isLoading ? <Loading /> : <ListItemsComp listItems={listItems} setListItems={setListItems} />}
                                                </div>
                                                <div className="tab-pane fade show active h-100" id="expensesTab" role="tabpanel">
                                                    {isLoading ? <Loading /> : <ExpensesComp expenses={expenses} setExpenses={setExpenses} />}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
